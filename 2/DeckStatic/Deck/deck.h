...
namespace Deck{
    ...
    public:
        ...
        /*!
         * @brief Getter that returns maximum number of cards in the deck
         */
        [[nodiscard]] static int get_card_max() { return card_max; }
        /*!
         ...
         * @param lhs Left Hand Side Deck example
         * @param rhs Right Hand Side Deck example
